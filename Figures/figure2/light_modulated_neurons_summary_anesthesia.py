...
# Load in results
all_neurons = pd.read_csv(join(save_path, 'light_modulated_neurons_anesthesia.csv'))
...
ax1.set(xticklabels=['SERT', 'WT'], ylabel='Mod. neurons (%)', ylim=[-1, 100], xlabel='',
        yticks=[0, 50, 100])
...
ax1.set(xlim=[0, 100], xticks=[0, 50, 100],
        yticks=[0, 175, 350])
