...
from stim_functions import paths, figure_style, high_level_regions
from sklearn.manifold import TSNE
from sklearn.decomposition import PCA
from sklearn.cluster import KMeans

# Settings
CLUSTER_N = 8  # number of clusters
PCA_DIM = 10
...
ax1.set(ylabel='Normalized firing rate', xlabel='Time (s)', xticks=[-1, 0, 1, 2, 3, 4],
