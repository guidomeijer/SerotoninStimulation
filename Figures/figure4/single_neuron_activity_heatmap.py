...
ax_mb.plot([0, 0], [-1.5, 1], ls='--', color='k')
...
ax_fc.plot([0, 0], [-1.5, 1], ls='--', color='k')
...
ax_str.plot([0, 0], [-1.5, 1], ls='--', color='k')
...
ax_th.plot([0, 0], [-1.5, 1], ls='--', color='k')
...
ax_am.plot([0, 0], [-1.5, 1], ls='--', color='k')
...
ax_sc.plot([0, 0], [-1.5, 1], ls='--', color='k')
...
ax_hc.plot([0, 0], [-1.5, 1], ls='--', color='k')
...
cb_ax = f.add_axes([0.45, 0.15, 0.01, 0.25])
