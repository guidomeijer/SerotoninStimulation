...
# Drop root and void
sert_neurons = sert_neurons[(sert_neurons['region'] != 'root') & (sert_neurons['region'] != 'void')]
wt_neurons = wt_neurons[(wt_neurons['region'] != 'root') & (wt_neurons['region'] != 'void')]
...
sns.swarmplot(x='sert-cre', y='perc_mod', data=all_mice, order=[1, 0], size=3, color='k',
              legend=None, ax=ax1)
ax1.set(xticklabels=['SERT', 'WT'], ylabel='5-HT modulated neurons (%)', ylim=[-1, 62], xlabel='',
        yticks=[0, 30, 60])
