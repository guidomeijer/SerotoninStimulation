...
# Load in data
hmm_ll_df = pd.read_csv(join(save_path, f'hmm_log_likelihood_anesthesia_{BIN_SIZE}ms_bins.csv'))
...
sns.lineplot(data=ll_mean_df[ll_mean_df['region'] == 'Frontal cortex'], x='n_states', y='ll_norm',
...
sns.lineplot(data=ll_mean_df[ll_mean_df['region'] == 'Sensory cortex'], x='n_states', y='ll_norm',
