...
sns.lineplot(x='opto_stim', y='threshold', hue='sert-cre', style='subject', estimator=None,
             ...
             markers=['o']*int(psy_df.shape[0]/4), palette=colors, hue_order=[1, 0],
