...
Refactored to use pd.concat for efficiency.
"""
...
REPO_PATH = 'C:\\Users\\guido\\Repositories\\SerotoninStimulation'

# Create a list to hold all the individual DataFrames
dfs_to_concat = []

# ZFM-02180, 2021-05-21
dfs_to_concat.append(pd.DataFrame(data={
...
dfs_to_concat.append(pd.DataFrame(data={
    ...
    'neuron_id': [23, 51, 109, 173, 120, 201, 202, 203, 205, 206, 207, 208, 209, 210, 220, 232, 234, 242, 244, 248, 253, 263]}))
...
# ignore_index=True creates a new, clean index for the final DataFrame
artifact_neurons = pd.concat(dfs_to_concat, ignore_index=True)
